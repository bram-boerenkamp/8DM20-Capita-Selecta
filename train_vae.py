...
DATA_DIR = Path.cwd().parent / "blurred_level_2"
CHECKPOINTS_DIR = Path.cwd() / "noise_level2_VAE_model_weights"
CHECKPOINTS_DIR.mkdir(parents=True, exist_ok=True)
TENSORBOARD_LOGDIR = "noise_level2_VAE_run"
...
vae_SPADE_model = vae.VAE_SPADE().to(device) 
...
#%%       
        loss = vae.vae_SPADE_loss(inputs=inputs.to(device),
